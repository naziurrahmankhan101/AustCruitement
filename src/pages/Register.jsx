...
const Register = () => {
  ...
  return (
    <div className='bg-bgColor w-full h-[100vh] flex items-center 
    justify-center p-6 ' >
      ...
      flex flex-row-reverse bg-primary rounded-xl overflow-hidden shadow-xl'>
        ...
        justify-center ' >
          ...
          <form className='py-8 flex flex-col gap-5'
            ...
            <div className='w-full flex flex-col lg:flex-row gap-1 and md:gap-2'>
            <TextInput
             name='firstName'
             label='First Name'
            ...
            <TextInput
             ...
             register={register("lastName", { 
              required: "Last Name is do not match!",
             } ) }
        ...
        justify-center bg-blue' >
          <div className='relative w-full flex items-center justify-center'>
              ...
              right-10 top-11 py-2 px-5 rounded-full'>
                <BsShare size={14}/>
