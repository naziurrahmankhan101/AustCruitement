        ...
        rounded-xl px-6 py-4'>
            ...
            [#66666645]'>
                <div className='flex gap-2 items-center text-ascent-2'>
                      <CiLocationOn className='text-x1 text-ascent'/>
            ...
            <div className='w-full flex flex-col gap-2 py-4 border-b border-
                [#66666645]'>
                    ...
                    <div className='flex items-center justify-between text-ascent-2'>
                ...
                <div className='w-full flex flex-col gap-4 py-4 pb-6'>
                      ...
                      <div className='flex gap-2 items-center text ascent-2'>
                        <BsInstagram className='text-x1 text-ascent-1'/>
                        <span className='text-ascent-2'>Instagram</span>
                      </div>

                      <div className='flex gap-2 items-center text ascent-2'>
                        <FaTwitterSquare className='text-x1 text-ascent-1'/>
                        <span className='text-ascent-2'> Twitter</span>
                      </div>

                      <div className='flex gap-2 items-center text ascent-2'>
                        <BsFacebook className='text-x1 text-ascent-1'/>
                        <span className='text-ascent-2'>Facebook</span>
                      </div>
                </div>
        </div>
